 ...
 */
@WebServlet("/Products/MinMaxPromotion")
public class MinMaxPromotion extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public MinMaxPromotion() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try (Connection conn = new ConnectJDBC().getConnection()) {
			...
			response.sendRedirect(request.getContextPath() + "/Products/PromotionAddForm.jsp");
